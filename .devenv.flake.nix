{
  inputs =
    let
      version = "1.9.0";
system = "x86_64-linux";
devenv_root = "/home/kinipk/NetBeansProjects/ES_Imobiliaria";
devenv_dotfile = "/home/kinipk/NetBeansProjects/ES_Imobiliaria/.devenv";
devenv_dotfile_path = ./.devenv;
devenv_tmpdir = "/run/user/1000";
devenv_runtime = "/run/user/1000/devenv-c06db9f";
